...
Code sessions, architecture decisions, feature work, and development logs.

## Topics

- [[project-structure]] — Repo root files: CLAUDE.md, .env, .gitignore, overall project skeleton
